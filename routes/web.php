...
use App\Http\Controllers\apps\EcommerceProductEdit;
use App\Http\Controllers\apps\EcommerceProductDelete;
...
Route::get('/product/{id}/edit', [EcommerceProductEdit::class, 'edit'])->name('product.edit');
Route::put('/product/{id}', [EcommerceProductEdit::class, 'update'])->name('product.update');
Route::delete('/product/{id}', [EcommerceProductDelete::class, 'destroy'])->name('product.delete');
