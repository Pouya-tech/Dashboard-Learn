...
<div class="app-ecommerce">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    ...
    <div class="d-flex flex-column justify-content-center">
      <h4 class="mb-1 mt-3">Add a new Product hossein</h4>
                ...
                <div class="tab-pane fade show active" id="restock" role="tabpanel">
                  ...
                  <div class="row mb-3 g-3 pe-md-5">
                    ...
                    <div class="col-12 col-sm-3">
                      <button class="btn btn-primary align-items-center"><i class='ti ti-check me-2 ti-xs'></i>Confirm</button>
                    </div>
                  </div>
                  <div>
                    <p class="mb-1"><span class="fw-semibold text-heading">Product in stock now: </span> <span>54</span></p>
                    <p class="mb-1"><span class="fw-semibold text-heading">Product in transit: </span> <span>390</span></p>
                    <p class="mb-1"><span class="fw-semibold text-heading">Last time restocked: </span> <span>24th June, 2023</span></p>
                    <p class="mb-1"><span class="fw-semibold text-heading">Total stock over lifetime: </span> <span>2430</span></p>
                  </div>
                </div>
                <!-- Shipping Tab -->
                  ...
                  <div>
                    ...
                    <div class="form-check mb-5">
                      ...
                      <label class="form-check-label" for="companyName">
                        <span class="fw-medium d-block mb-1">Fulfilled by Company name &nbsp;<span class="badge rounded-2 badge-warning bg-label-warning fs-tiny py-1 border border-warning">RECOMMENDED</span></span>
